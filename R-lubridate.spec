...
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/lubridate_1.9.4.tar.gz
...
%setup -q -n lubridate
pushd ..
cp -a lubridate buildavx2
popd
pushd ..
cp -a lubridate buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733822509
...
/usr/lib64/R/library/lubridate/WORDLIST
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/lubridate/libs/lubridate.so
/V4/usr/lib64/R/library/lubridate/libs/lubridate.so
